...
public class enemy2 extends GameObject{
	...
	public enemy2(int x, int y, ID id, Handler handler, SpriteSheet Sprites) {
		super(x, y, id, Sprites, false);
		this.handler = handler;
		
		enemy_image_down[0] = Sprites.grabImage(7, 13, 32, 32);
		enemy_image_down[1] = Sprites.grabImage(8, 13, 32, 32);
		enemy_image_down[2] = Sprites.grabImage(9, 13, 32, 32);
		
		enemy_image_up[0] = Sprites.grabImage(7, 16, 32, 32);
		enemy_image_up[1] = Sprites.grabImage(8, 16, 32, 32);
		enemy_image_up[2] = Sprites.grabImage(9, 16, 32, 32);
		
		enemy_image_left[0] = Sprites.grabImage(7, 14, 32, 32);
		enemy_image_left[1] = Sprites.grabImage(8, 14, 32, 32);
		enemy_image_left[2] = Sprites.grabImage(9, 14, 32, 32);
		
		enemy_image_right[0] = Sprites.grabImage(7, 15, 32, 32);
		enemy_image_right[1] = Sprites.grabImage(8, 15, 32, 32);
		enemy_image_right[2] = Sprites.grabImage(9, 15, 32, 32);
